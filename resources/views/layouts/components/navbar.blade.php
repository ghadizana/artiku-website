 <!-- Navbar -->
 <nav class="navbar fixed-top navbar-expand-lg bg-primmary-bg-subtle shadow p-3 mb-5 bg-body-tertiary rounded">
     <div class="container">
         ...
         <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
             <ul class="me-auto justify-content-end navbar-nav collapse navbar-collapse " id="navbarTogglerDemo02">
                 ...
                 @guest
                     ...
                     <li class="nav-item">
                         <a class="btn btn-outline-danger shadow rounded-pill" href="{{ route('register') }}" type="button">
                             Get Started
                         </a>
                     </li>
                 @else
                     <a href="{{ url('/articles') }}" class="btn btn-primary">My Blog</a>
