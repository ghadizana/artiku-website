            ...
            <form method="POST" action="{{ url('/articles') }}" enctype="multipart/form-data">
                ...
                <div class="col-md-12 col-sm-12 bg-white p-4">
                    <div class="form-group">
                        <input type="text" class="form-control fs shadow" style="border-style: none" name="title"
                    ...
                    <div class="form-group">
                        <textarea class="form-control mt-4 shadow" style="border-style: none" name="synopsis" rows="5"
                            placeholder="Type the synopsis here">{{ old('synopsis') }}</textarea>
                        @error('synopsis')
                            <span class="text-danger">
                                {{ $message }}
                            </span>
                    ...
                    <div class="mb-3">
                        <input class="form-control mt-4 shadow" style="border-style: none" type="file" id="formFile"
                            name="image" />
                        @error('image')
                            <span class="text-danger">
                                {{ $message }}
